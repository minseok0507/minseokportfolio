...
import RollingSkillsBanner from "@/components/rolling-skills-banner";
        ...
        (<div
                ...
                <section id="about" className="mb-12">
                    ...
                    <div className="flex">
                        <p className="text-gray-600 dark:text-gray-300 pr-5">
                            I'm a passionate full-stack web developer with 5 years of experience in creating robust and
                            scalable web
                            applications.
            ...
            <footer className="bg-white dark:bg-gray-800 shadow">
                <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
                    <p className="text-center text-gray-500 dark:text-gray-400">© 2023 Jane Doe. All rights
                        reserved.</p>
                </div>
            </footer>
        </div>)
